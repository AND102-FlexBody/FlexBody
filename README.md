...
* [x] [R6] Users have a personal feed
    * [x] Users can see the titles of their created lists(CUT FROM THIS BUILD)
    * [x] Users can see their image uploads
 * [x] [R7] User can search for nutrition information to add to nutrition list
    * [x] Create exercise list nutrition (search for nutrition)
    * [x] API returns nutrition from Public endpoint
